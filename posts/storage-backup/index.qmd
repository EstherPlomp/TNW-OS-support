...
When working with regular research data (no personal/confidential data) you can use either SURFdrive (1 TB) or OneDrive (1 TB) as an active storage solution, and then regularly back things up using the Project Drive. See the [Storage Solutions page](https://estherplomp.github.io/TNW-OS-support/posts/storage-solutions/) for more information about these solutions.
