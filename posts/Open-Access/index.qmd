...
<https://zenodo.org/records/5706310/preview/commercial-infrastrcuture.jpg?include_deleted=0>

![](images/open-access.jpg){fig-alt="An overview of the different open access options. Diamond is indicated with a diamond coloured open access logo (an open lock), explaining that this is published without charges. Green open access has a green open access logo and the text: self-archiving using repositories without charges. Gold open acces has a yellow/gold open access logo and says published with charges. Hybrid has two hungry dragons saying pay me, with the text published or read with charges. Bronze has a drawn pile of poop with the text published without clear reuse permission."}
