...
-   **Review files for errors** such as missing data, misnamed files/variables, incorrectly formatted values, and corrupted
    files (you can use tools such as [OpenRefine](https://openrefine.org/) or [Frictionless](https://framework.frictionlessdata.io/))
